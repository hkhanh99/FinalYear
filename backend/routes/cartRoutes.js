...
//Add product to cart for guest or logged in user
...
router.delete("/", async (req, res) => {
    ...
    console.log("Delete request received:", { productId, size, color, guestId, userId });
...
//Get logged in user's or guest cart
