...
const selectedProduct = {
    ...
    price: 340,
    originalPrice: 360,
    description: "The Nintendo Switch OLED features a premium 7-inch OLED display with enhanced contrast, 64GB storage, improved audio, a wider adjustable stand, and a wired LAN port in the dock, all while maintaining the same portable hybrid gameplay experience as the original Switch.",
    material: "plastic",
    brand: "Nintendo",
    color: ["Red", "Black"],
    images: [
